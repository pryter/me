  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-rose-100 to-teal-100">
      <div className="text-xs fixed bottom-2 left-0 text-center w-full">
        <a href="service" className="cursor-pointer text-gray-500">Inspect service</a>
      </div>
      <div className="flex flex-col items-center mb-4">
        <div className="w-32 h-32 relative rounded-full shadow-md border-4">
          <Image layout="fill" src="/assets/images/whaly.jpeg" className="relative rounded-full"/>
        </div>
      <h1 className="font-bold text-2xl text-black">Whaly</h1>
      <p className="text-gray-600 bg-gray-100 px-4 rounded-lg">A lonely ginger cat.</p>
      </div>
      <div className="flex flex-col items-center rounded-lg px-4 py-4">
      <button onClick={() => {window.location.href = "https://discord.com/oauth2/authorize?client_id=880000846828535818&permissions=277083450689&scope=bot%20applications.commands"}} className="flex items-center space-x-2 pl-6 pr-5 py-2 bg-gradient-to-r from-orange-300 to-rose-300 text-gray-100 rounded-xl shadow-md bg-opacity-50 font-medium cursor-pointer">
